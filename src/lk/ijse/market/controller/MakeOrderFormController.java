...
import lk.ijse.market.view.TM.CartTM;
...
public class MakeOrderFormController {
    ...
    public void ComfirmOrderOnAction(ActionEvent actionEvent) throws IOException {
        ArrayList<lk.ijse.market.model.OrderDetails>items=new ArrayList<>();
        double total=0;
        ...
        Order order = new Order(lblOrderID.getText(),lblDate.getText(), (String) cmbCustomerID.getValue(),items);
